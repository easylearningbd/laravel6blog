				...
				<div class="col-lg-4 col-md-12 no-left-padding">
					...
					<div class="single-post info-area">
						...
						<div class="sidebar-area about-area">
							...
							<p align="justify">{{ $post->user->about }} </p>
						</div>
						...
						<div class="single-post post-style-1">
							...
							<div class="blog-info">
								...
								<ul class="post-footer">
                                    <li>
                               @guest
             <a href="#" onclick="fav()" ><i class="ion-heart"></i> {{ $randompost->favorite_to_users->count() }} </a>
                               @else
 <a href="javascript::void(0)" 
 onclick="document.getElementById('favorite-form-{{ $randompost->id }}').submit(); " 
class="{{ !Auth::user()->favorite_posts->where('pivot.post_id',$randompost->id)->count() == 0 ? 'favorite_post' : '' }}"> <i class="ion-heart"></i>
